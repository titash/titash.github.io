...
**Senior Cloud Data Engineer** | 170 76, Solna, Sweden  
titash@live.in | +46 70-739 37 85
...
### DWH ETL Developer — SEB Life & Pension
*Stockholm, Sweden | 2020-07 – 2022-06*
...
### International Data Consultant — Ataccama s.r.o
*Prague, Czech Republic | 2019-11 – 2020-06*
...
### ETL Developer — SEB Life International
*Kuala Lumpur, Malaysia | 2018-05 – 2019-11*
...
### Software Engineer II – Business Intelligence — Aon India Services Ltd
*Noida, India | 2016-04 – 2018-04*
...
### Solutions Engineer – Business Intelligence — Aditi Technologies Ltd
*Bangalore, India | 2013-04 – 2016-03*
...
### Mock Data API — [python_api](https://github.com/titash01/python_api)
*Python, Flask*

Scalable mock data generation API for testing and development environments.

- Generates configurable records with realistic data distributions
- REST API built with Flask; supports JSON and CSV export formats
- Extensible design enables production-grade fake data generation for ETL testing

## Education

**Bachelor of Engineering in Information Technology**  
Rajiv Gandhi Technical University, Bhopal, India (2008-2012)
...
English (Fluent) | Swedish (Intermediate) | Hindi (Native)

## Download as PDF

<a class="pdf-download-btn" href="../pdf/resume.pdf" download>Download as PDF</a>
